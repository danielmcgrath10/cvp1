...
b = uicontrol('Parent',f,'Style','slider', 'SliderStep',[1/count, 1/count],...
    'Position',[390,0,419,23],'value',1, 'min',1, 'max',count);
bgcolor = f.Color;
bl1 = uicontrol('Parent',f,'Style','text','Position',[360,0,23,23],...
                'String',num2str(start_img),'BackgroundColor',bgcolor);
bl2 = uicontrol('Parent',f,'Style','text','Position',[810,0,30,23],...
                'String',num2str(stop_img),'BackgroundColor',bgcolor);     
b.Callback = @plotImageCallback;

t = uicontrol('Parent',f,'Style','edit', 'Units', 'pixels',...
    'Position',[900,0,50,23]);
bgcolor = f.Color;
tl1 = uicontrol('Parent',f,'Style','text','Position',[860,0,53,23],...
...
function plotImageCallback(src, event)
    ...
    imgs = evalin('base', 'masked_images');
